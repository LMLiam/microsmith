...
class CliPackagingPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        project.dependencies.apply {
            ...
            add("implementation", project.project(":lower"))
            add("implementation", project.project(":lower-schemas-protobuf"))
            add("implementation", project.project(":lower-schemas-protobuf-rpc"))
            ...
            add("implementation", project.project(":gen-schemas-protobuf-rpc"))
