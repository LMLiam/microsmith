...
internal fun Message.renderMessage(): String =
    buildString {
...
internal fun Enum.renderEnum(): String =
    buildString {
...
private fun Oneof.renderOneof(): String =
    buildString {
...
private fun Cardinality.renderPrefix(): String =
    when (this) {
...
private fun ValueType.renderValueType(): String =
    when (this) {
...
private fun Reserved.renderReservedIndex(): String =
    when (this) {
